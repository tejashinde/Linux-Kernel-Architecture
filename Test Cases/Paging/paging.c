#include <stdio.h>
#include <stdlib.h>
/* Structure for Main Memory containing data element to store the process, key to store the process id of the incoming process and a self referential pointer to oint the next process in the main memory*/
struct MainMemory{
    int data;
    int key;
